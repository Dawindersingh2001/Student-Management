...
const Home = () => {
    ...
    const deleteu=(id)=>{
        ...
        const result = getuserdata.filter(word => word.id != id);

        setUserdata(result);
        setDeleted(true);
        }
        // For Parmanetly Delete From Data Base
                                        ...
                                        <>
                                            <tr>
                                                ...
                                                <td className="d-flex justify-content-between">
                                                    ...
                                                    <button className="btn btn-danger" onClick={() => deleteu(element.id)}><DeleteOutlineIcon /></button>
                                                </td>
                                            </tr>
                                        </>
                                    )
