...
const Edit = () => {
    ...
    const updateuser = async (e) => {
        ...
        const res2 = await fetch(`/updateuser/${id}`, {
            ...
            body: JSON.stringify({
                name, email, fname, mname, add, rdate, desc, age
            })
        });
            ...
            <form className="mt-4">
                <div className="row">
                    ...
                    <div class="mb-3 col-lg-6 col-md-6 col-12">
                        ...
                        <input type="text" value={inpval.fname} onChange={setdata} name="fname" class="form-control" id="exampleInputPassword1" />
                    </div>
                    <div class="mb-3 col-lg-6 col-md-6 col-12">
                        <label for="exampleInputPassword1" class="form-label">Mother Name</label>
                        <input type="text" value={inpval.mname} onChange={setdata} name="mname" class="form-control" id="exampleInputPassword1" />
                    </div>
                    <div class="mb-3 col-lg-6 col-md-6 col-12">
