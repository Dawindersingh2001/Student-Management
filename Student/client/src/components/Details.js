...
const Details = () => {
    ...
    return (
        <div className="container mt-3 ">
            <h1 style={{ fontWeight: 400 }}>Student Information</h1>
                ...
                <CardContent>
                    ...
                    <div className="row">
                        <div className="left_view col-lg-6 col-md-6 col-12">
                            ...
                            <h3 className="mt-3">Student Name: <span >{getuserdata.name}</span></h3>
                            <h5 className="mt-3">Father Name: <span >{getuserdata.fname}</span></h5>
                            <h5 className="mt-3">Mother Name: <span >{getuserdata.mname}</span></h5>
                            <h3 className="mt-3">Age: <span >{getuserdata.age}</span></h3>
                            <p className="mt-3"><MailOutlineIcon />Email: <span>{getuserdata.email}</span></p>
                            <h6 className="mt-3">Registartion Date: <span >{moment(getuserdata.rdate).format("MMMM Do YYYY")}{" "}</span></h6>
